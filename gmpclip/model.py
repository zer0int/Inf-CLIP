...
class CLIP(nn.Module):
    ...
    def forward(self, image, text, return_raw_features=True):
        # Get raw image and text features
        image_features = self.encode_image(image)
        text_features = self.encode_text(text)

        if return_raw_features:
            # Return unnormalized raw features directly
            return image_features, text_features
        else:
            # If not raw, proceed with normalization and scaling
